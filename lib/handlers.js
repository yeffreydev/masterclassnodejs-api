                    ...
                    _data.delete("checks", checkId, function (err) {
                      ...
                      if (checksDeleted === checkstoDelete) {
                        if (!deletionErrors) {
                          ...
                          callback(500, {
                            Error:
                              "errors enconterred while attempting to delete all of the users's checks. All checks may not have been deleted form thes system successfully",
                          });
                        }
                      }
                    });
                    ...
                    function (err, userData) {
                      if (!err && userData) {
                        ...
                        if (checkPosition > -1) {
                          ...
                          callback(500, {
                            Error:
                              "Could not find the check on the users object, so could not removed",
                          });
                        }
                      } else {
                        callback(500, {
